...
@Component({
  selector: 'app-interface-cours-etudient',
  templateUrl: './interface-cours-etudient.component.html',
  styleUrl: './interface-cours-etudient.component.scss'
})
export class InterfaceCoursEtudientComponent {
  courses: any[] = [];
  ...
  redirectToContenu() {
    ...
    this.router.navigate(['/contenuEtudient']);
  }
